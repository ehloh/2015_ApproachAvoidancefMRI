...
% Omega=x(:,4);       % Omega: Multiplier-utility of variance 

Omega= (1./(2+2.*exp(-x(:,4)))) - 0.25; 
...
posVacc=posVacc+DistortVaccExp   + StanDev.*om;  % Distortions 
posVrej=0;
...
clearvars  om StanDev OutcomeMean  EV_NoSee EnvThreat ExploreCost FixedLoss NTok V_AccGivNoSee data_cF nT_cF pAccGivNoBombSeen pActBomb posVacc posVrej ppActBomb ppABscaled miscvar EnvThreatDistort ov 
