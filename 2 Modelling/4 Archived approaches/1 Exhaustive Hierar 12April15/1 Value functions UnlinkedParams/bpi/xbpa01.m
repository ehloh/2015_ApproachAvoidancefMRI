function [ V ] = bpa01(x, modelinput)
% Model's value function: [ V ] = bpa01(x, modelinput)
%   Value function with inoptimal posterior probability calculation, distortion of V(Accept|~See)
%
%  - Inputs
