function [ V ] = b10_fow(x, modelinput)
%   Basic value function + Subjective value of Loss + Variable exploration bonus (w) x EntropyNTok  (o)
%
%  - Inputs
...
V(:,:,3)=V(:,:,3)  +   repmat(ExploreBonus, [1 nTrials]).*repmat(data(:,col.EntropyNTok)', [nPP 1]);
