...
% Model's value function: [ V ] = b01(x, {[]    data   fPar   col})
%   Basic value function (Using Bayesian probabilities for V(Explore))
%
%  - Inputs
...
%
% ---------------------------------------------------------------------------------------------------------------------------------
% Free parameters 'x':        x(1)=beta        (Applied outside of value fxn)
% ---------------------------------------------------------------------------------------------------------------------------------
...
V_cF(:,:,3)= 0 +  repmat(1- (data_cF(:, col.pLoss).*0.5)', [nPP 1])  .* EV_NoSee +  repmat(fPar.cF_EC, [1 nT_cF]);
