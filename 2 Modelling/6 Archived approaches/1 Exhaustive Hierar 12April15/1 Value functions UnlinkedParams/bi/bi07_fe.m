function [ V ] = bi07_fe(x, modelinput)
% Distortion of V(Accept|~See) + Subjective value of Loss  + Fixed exploration bonus
%
%  - Inputs
...
% Get parameters in model (for identification of e param)
