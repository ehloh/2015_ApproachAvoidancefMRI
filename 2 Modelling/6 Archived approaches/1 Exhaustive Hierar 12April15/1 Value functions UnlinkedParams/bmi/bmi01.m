...
clearvars EV_NoSee EnvThreat ExploreCost FixedLoss NTok V_AccGivNoSee data_cF nT_cF pAccGivNoBombSeen pActBomb posVacc posVrej ppActBomb ppABscaled
if size(whos,1)>14; disp('Workspace clear from cF to ct: more parameters in workspace than usual'); end
