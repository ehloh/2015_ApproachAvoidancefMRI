function [ V ] = bpa02_f(x, modelinput)
% Inoptimal value function (post-prob) + distortion of V(Accept|~See) + Variable subjective Fixed loss (only applicable for cF task)
%
%  - Inputs
