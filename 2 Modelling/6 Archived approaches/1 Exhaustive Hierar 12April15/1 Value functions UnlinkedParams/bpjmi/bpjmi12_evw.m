function [ V ] = bm12_evw(x, modelinput)
% Inoptimal value function (post-prob multiplier) + Fixed exploration bonus (e) + Variable exploration bonus (w) x VExplore (v)
%
%  - Inputs
...
[ V ] = bpjmi01(x, {modname data, fPar,col});
