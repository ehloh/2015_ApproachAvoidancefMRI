...
% details.dataset_date='(29-Mar-2016) Half2';
ThisPC='Mac_NEWMODS';
...
which=1:24; 
% which =1; % details.modelfams.ct_modnums;
details.whichmodels=[
...
%     details.modelfams.bpji([1 3 4])];

details.whichmodels={'bpio04_uw'; 
%     'bpio08_fuw'; 'bpjio08_fuw'
...
% details.whichmodels = details.cf_winandneighbours ;
% details.whichmodels = details.cf_winandneighbours ;
