...
par_specs={       
    ...
    'o'    '(1./(2+2.*exp(-x))) - 0.25'    '-log( (2./(4.*x+1)) -1)'     [-0.2     0.2];                                        % o: omega, value multiplier on outcome variance 
...
%     'allpars'            8        {'b'; 'p'; 'j'; 'm';'i'; 'f'; 'e'; 'w'; 'q'};
    ...
    % Models for Cerebral Cortex Reviews 1 
    'bpjio08_fuw'    7        {'b'; 'p'; 'j'; 'i';  'o'; 'f'; 'w'; };
    'bpio08_fuw'    6       {'b'; 'p'; 'i';'o'; 'f'; 'w';};
    'bpio04_uw'    5        {'b'; 'p'; 'i'; 'o';'w';};
