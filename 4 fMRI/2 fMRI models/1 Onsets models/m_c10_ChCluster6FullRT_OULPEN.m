...
% CHOICE regressors
[variables c] =  i_choiceRT_conditions_cluster(datastruc{1}, [], 'cF_', {'Accept';'Reject';'Explore'}, col, c,InnerCluster ); % Conflict
[variables c] =  i_choiceRT_conditions_cluster(datastruc{2}, variables,  'ct_', {'NoBomb';'Bomb';'Explore'}, col, c,InnerCluster ); % Control
