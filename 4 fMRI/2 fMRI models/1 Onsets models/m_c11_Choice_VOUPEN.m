function [variables c] = m_c11_Choice_VOUPEN(datastruc, col, c)
% Full -EV + VExplore model: VExplore (V), EntropyNTok (O), Entropy (U), pLoss (P), EnvThreat (E), NTokens (N)
...
RLvariables={'VExplore'; 'EntropyNTok'; 'Entropy'; 'pLoss'; 'EnvThreat'; 'NTokens'}; 
