function [variables c] = m_c12_Choice_VOULPEN(datastruc, col, c)
% Full + VExplore model: VExplore (V), EntropyNTok (O), Entropy (U), pLoss (P), EnvThreat (E), NTokens (N)
...
RLvariables={'VExplore'; 'EntropyNTok'; 'Entropy'; 'EV'; 'pLoss'; 'EnvThreat'; 'NTokens'}; 
