function [variables c] = m_c6_ChCluster4Full_OULPEN(datastruc, col, c)
...
RLvariables={'EntropyNTok'; 'Entropy';  'EV'; 'pLoss'; 'EnvThreat'; 'NTokens';}; % OULPEN
...
% Define inner cluster: 4 cells
InnerCluster=[3 5; 3 6; 4 5;4 6];
