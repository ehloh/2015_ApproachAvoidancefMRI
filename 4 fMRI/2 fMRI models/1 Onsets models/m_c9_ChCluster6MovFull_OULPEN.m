function [variables c] = m_c9_ChCluster6MovFull_OULPEN(datastruc, col, c)
...
RLvariables={'EntropyNTok'; 'Entropy';  'EV'; 'pLoss'; 'EnvThreat'; 'NTokens';}; % XUVPEN

Min_percent=0.0;% Minimum % of responses of Reject/Bomb & Explore for entire cluster
N_cells=6; % Size of inner cluster
