...
[variables c] =  i_Tasktrial_pmod_Competing(datastruc{1}(datastruc{1}(:,col.TrialValid)==1, :), [], 'cF_', {'vGamble'}, col, c ); % Conflict
[variables c] =  i_Tasktrial_pmod_Competing(datastruc{2}(datastruc{2}(:,col.TrialValid)==1, :), variables, 'ct_', {'vGamble'}, col, c ); % Control
...
[variables c] = i_outcomePE(datastruc{1}, 'cF_', {'Magnitude'}, variables, col, c );
[variables c] = i_outcomePE(datastruc{2}, 'ct_', {'Magnitude'}, variables, col, c );
