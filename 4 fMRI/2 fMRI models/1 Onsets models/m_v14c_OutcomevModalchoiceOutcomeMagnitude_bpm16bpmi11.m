...
[variables c] =  i_TaskTrialOnset(datastruc{1}(datastruc{1}(:,col.TrialValid)==1, :), [], 'cF_', { }, col, c ); % Conflict
[variables c] =  i_TaskTrialOnset(datastruc{2}(datastruc{2}(:,col.TrialValid)==1, :), variables, 'ct_', { }, col, c ); % Control
...
[variables c] = i_outcomePE(datastruc{1}, 'cF_', {'vModalchoice', 'Magnitude'}, variables, col, c );
[variables c] = i_outcomePE(datastruc{2}, 'ct_', {'vModalchoice', 'Magnitude'}, variables, col, c );

% NO-INTEREST regressors
[variables c] = i_nointerest(datastruc{3}, {'OutcomeOnly';'Error'; 'Motor'}, variables, col, c );
