...
[variables c] = i_ExploreInfoVals( datastruc{1}(datastruc{1}(:,col.TrialValid)==1, :), 'cF_', {'Presented'; 'vExplore'; 'vExploreInfoVal'}, variables, col, c );
[variables c] = i_ExploreInfoVals( datastruc{2}(datastruc{2}(:,col.TrialValid)==1, :), 'ct_', {'Presented'; 'vExplore'; 'vExploreInfoVal'}, variables, col, c );
