...
[variables c] =  i_Outcome_pmod_Competing( d_shown{1}( d_shown{1}(:, col.Resp1)==1,:) , variables, 'cF_', {'AcceptOutcomePE'}, col, c ); % Conflict;
[variables c] =  i_Outcome_pmod_Competing( d_shown{1}( d_shown{1}(:, col.Resp1)==2,:) , variables, 'cF_', {'RejectOutcomePE'}, col, c ); 
[variables c] =  i_Outcome_pmod_Competing( d_shown{1}( d_shown{1}(:, col.Resp1)==3,:) , variables, 'cF_', {'ExploreInfotoOutcomePE'}, col, c ); 
[variables c] =  i_Outcome_pmod_Competing( d_shown{2}( d_shown{2}(:, col.Resp1)==1,:) , variables, 'ct_', {'AcceptOutcomePE'}, col, c ); % Control task
[variables c] =  i_Outcome_pmod_Competing( d_shown{2}( d_shown{2}(:, col.Resp1)==2,:) , variables, 'ct_', {'RejectOutcomePE'}, col, c ); 
...
[variables c] = i_ExploreInfoVals( d_shown{1} (d_shown{1}(:,col.TrialValid)==1, :), 'cF_', {'Presented'; 'ExploreInfoPE'}, variables, col, c );
[variables c] = i_ExploreInfoVals( d_shown{2} (d_shown{2}(:,col.TrialValid)==1, :), 'ct_', {'Presented'; 'ExploreInfoPE'}, variables, col, c );
