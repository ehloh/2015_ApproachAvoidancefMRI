...
% Outcome-UNSHOWN value regressors (cF/ct trials, with pmods describing values)
[variables c] =  i_Tasktrial_pmod_Competing(d_unshown{1}(  d_unshown{1}(:, col.Resp1)==1,:), variables, 'cF_', {'vAccept';}, col, c ); % Conflict
[variables c] =  i_Tasktrial_pmod_Competing(d_unshown{1}(  d_unshown{1}(:, col.Resp1)==2,:), variables, 'cF_', {'vReject';}, col, c );
[variables c] =  i_Tasktrial_pmod_Competing(d_unshown{1}(  d_unshown{1}(:, col.Resp1)==3,:), variables, 'cF_', {'vExplore';}, col, c ); 
[variables c] =  i_Tasktrial_pmod_Competing( d_unshown{2}(  d_unshown{2}(:, col.Resp1)==1,:), variables, 'ct_', {'vAccept'}, col, c ); % Control (column-choice names still= Accept/Reject/Explore)
[variables c] =  i_Tasktrial_pmod_Competing( d_unshown{2}(  d_unshown{2}(:, col.Resp1)==2,:), variables, 'ct_', {'vReject'}, col, c ); 
[variables c] =  i_Tasktrial_pmod_Competing( d_unshown{2}(  d_unshown{2}(:, col.Resp1)==3,:), variables, 'ct_', {'vExplore'}, col, c ); 
...
[variables c] =  i_Outcome_pmod_Competing( d_shown{1}( d_shown{1}(:, col.Resp1)==1,:) , variables, 'cF_', {'vAccept';'AcceptOutcomeMagnitude'}, col, c ); % Conflict;
[variables c] =  i_Outcome_pmod_Competing( d_shown{1}( d_shown{1}(:, col.Resp1)==2,:) , variables, 'cF_', {'vReject';'RejectOutcomeMagnitude'}, col, c ); 
[variables c] =  i_Outcome_pmod_Competing( d_shown{1}( d_shown{1}(:, col.Resp1)==3,:) , variables, 'cF_', {'vExplore';'ExploreOutcomeMagnitude'}, col, c ); 
[variables c] =  i_Outcome_pmod_Competing( d_shown{2}( d_shown{2}(:, col.Resp1)==1,:) , variables, 'ct_', {'vAccept'; 'AcceptOutcomeMagnitude'}, col, c ); % Control task
[variables c] =  i_Outcome_pmod_Competing( d_shown{2}( d_shown{2}(:, col.Resp1)==2,:) , variables, 'ct_', {'vReject';'RejectOutcomeMagnitude'}, col, c ); 
[variables c] =  i_Outcome_pmod_Competing( d_shown{2}( d_shown{2}(:, col.Resp1)==3,:) , variables, 'ct_', {'vExplore';'ExploreOutcomeMagnitude'}, col, c ); 
