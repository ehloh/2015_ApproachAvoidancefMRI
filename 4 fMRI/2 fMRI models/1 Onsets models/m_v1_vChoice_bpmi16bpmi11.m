function [variables c] = m_v1_vChoice_bpm16bpm11(datastruc, col, c)
% [variables c] = m_v1_vChoice_bpm16bpm11(datastruc, col, c)
% V(Accept), V(Reject), and V(Explore), for each subject
...
[variables c] =  i_Tasktrial_pmod_Competing(datastruc{1}, variables, 'cF_', {'vAccept';'vReject';'vExplore'}, col, c ); % Conflict
[variables c] =  i_Tasktrial_pmod_Competing(datastruc{2}, variables, 'ct_', {'vAccept';'vReject';'vExplore'}, col, c ); % Control (column-choice names still= Accept/Reject/Explore)
