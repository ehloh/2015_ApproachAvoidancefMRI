...
[variables c] =  i_Outcome_pmod_Competing( d_shown{1}( d_shown{1}(:, col.Resp1)==3,:), variables, 'cF_', {'ExploreInfotoOutcomePE';'ExploreGambletoOutcomePE'}, col, c ); 
[variables c] =  i_Outcome_pmod_Competing( d_shown{2}( d_shown{2}(:, col.Resp1)==3,:), variables, 'ct_', {'ExploreInfotoOutcomePE';'ExploreGambletoOutcomePE'}, col, c ); 
