...
% cF 
[variables c] =  i_Tasktrial_pmod_Competing( data_r{1}, variables, 'cF_', {'Rej_vGamble';}, col, c );             % vBU split by RejOr
[variables c] =  i_Tasktrial_pmod_Competing( data_nr{1}, variables, 'cF_', {'NonRej_vGamble';}, col, c );   

% ct
[variables c] =  i_Tasktrial_pmod_Competing( data_r{2}, variables, 'ct_', {'Rej_vGamble';}, col, c );             % vBU split by RejOr
[variables c] =  i_Tasktrial_pmod_Competing( data_nr{2}, variables, 'ct_', {'NonRej_vGamble';}, col, c );   
