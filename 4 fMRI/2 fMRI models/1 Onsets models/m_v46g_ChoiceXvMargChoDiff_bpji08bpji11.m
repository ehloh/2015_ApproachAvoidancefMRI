...
% cF 
[variables c] = i_Tasktrial_pmod_Competing( data_a{1}, variables, 'cF_', {'Acc_vMargChosen';}, col, c );             % vBU split by RejOr
[variables c] = i_Tasktrial_pmod_Competing( data_r{1}, variables, 'cF_', {'Rej_vMargChosen';}, col, c ); 
[variables c] = i_Tasktrial_pmod_Competing( data_e{1}, variables, 'cF_', {'Exp_vMargChosen';}, col, c ); 

% ct
[variables c] = i_Tasktrial_pmod_Competing( data_a{2}, variables, 'ct_', {'Acc_vMargChosen';}, col, c );             % vBU split by RejOr
[variables c] = i_Tasktrial_pmod_Competing( data_r{2}, variables, 'ct_', {'Rej_vMargChosen';}, col, c );
[variables c] = i_Tasktrial_pmod_Competing( data_e{2}, variables, 'ct_', {'Exp_vMargChosen';}, col, c );
