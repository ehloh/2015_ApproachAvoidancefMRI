function [variables c] = m_v4b_ChoicevChosenAnd_bpm16bpm11(datastruc, col, c)
...
%
%Unlike model v4 (not v4b), this model includes onsets for the choice events themselves. 
%
...
% Event onsets themselves
[variables c] =  i_TaskTrialOnset(datastruc{1}, variables, 'cF_',  ' ', col, c ); 
[variables c] =  i_TaskTrialOnset(datastruc{2}, variables, 'ct_',  ' ', col, c ); 
