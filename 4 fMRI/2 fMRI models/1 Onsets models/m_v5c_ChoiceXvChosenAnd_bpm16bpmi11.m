function [variables c] = m_v5_ChoiceXvChosenAnd_bpm16bpm11(datastruc, col, c)
...
[variables c] =  i_Choice_pmod_Competing(datastruc{1}(datastruc{1}(:,col.TrialValid)==1, :), variables, 'cF_', {'vChosen'; 'vBestUnchosen'}, col, c ); % Conflict
[variables c] =  i_Choice_pmod_Competing(datastruc{2}(datastruc{2}(:,col.TrialValid)==1, :), variables, 'ct_', {'vChosen'; 'vBestUnchosen'}, col, c ); % Control
