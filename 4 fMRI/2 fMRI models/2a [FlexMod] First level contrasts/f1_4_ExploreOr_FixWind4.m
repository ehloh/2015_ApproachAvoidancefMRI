function [Con log] = f3_ExploreOr_FixWind4(where, log)
...
% Exclude subjects who have <20% Explore/Non-Explore overall in these cells (not per
% cell)
%
...
for o1=1:1 
    ...
    Analysis{m,3}.Covar=[]; % No covariates
    ...
    % [DISUSED FORMAT: Full Factorial ] ###############################
    for o2=1:1 % [DISUSED] To use flexible factorial with real factorial design 
%     Analysis{m,3}.Design{2}.name='Task';      % Factor 1: Task
%     Analysis{m,3}.Design{2}.levels=2;
%     Analysis{m,3}.Design{2}.dept=0;
%     Analysis{m,3}.Design{2}.variance=1;
%     Analysis{m,3}.Design{2}.gmsca=0;
%     Analysis{m,3}.Design{2}.ancova=0;
%     Analysis{m,3}.Design{3}.name='Explore';      % Factor 2: Explore
%     Analysis{m,3}.Design{3}.levels=2;
%     Analysis{m,3}.Design{3}.dept=0;
%     Analysis{m,3}.Design{3}.variance=1;
%     Analysis{m,3}.Design{3}.gmsca=0;
%     Analysis{m,3}.Design{3}.ancova=0;
%     Analysis{m,3}.Design{1}.name='Subject';      % Factor 3: Subjects
%     Analysis{m,3}.Design{1}.levels=log.n_subjs;
...
%     end
    ...
    for o2=1:1 % [DISUSED] Subject covariates with the (non-flexible) Full Factorial
...
for o1=1:1 
    ...
    Analysis{m,3}.ConInstruc={'ME_Task'                                 [1 1 -1 -1]         2;                                  % Factorial F contrasts
                                                ...
                                                % T-contrasts
                                                'ConflictTask'                [1 1 0 0   SubCovarWeights*2]         1;     % Main factor means
                                                'ControlTask'                [0 0 1 1   SubCovarWeights*2]         1;
                                                'Explore'                       [1 0 1 0   SubCovarWeights*2]         1;
                                                'NonExplore'                [0 1 0 1   SubCovarWeights*2]         1;
                                                'cF_Explore'                [1 0 0 0   SubCovarWeights*1]         1;        % Cell means
                                                'ct_Explore'                [0 0 1 0   SubCovarWeights*1]         1;
                                                'cF_NonExplore'           [0 1 0 0   SubCovarWeights*1]         1;
                                                'ct_NonExplore'             [0 0 0 1   SubCovarWeights*1]         1;
...
% Analysis{1,3}.Cells_FacAssignment
