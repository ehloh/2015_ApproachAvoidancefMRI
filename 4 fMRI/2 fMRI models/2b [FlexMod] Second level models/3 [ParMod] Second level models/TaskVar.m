...
% choices={'cF_vChosen' [1 1];'cF_vBestUnchosen'  [1 2];'ct_vChosen'  [2 1];'ct_vBestUnchosen'  [2 2]}; condnames={'cF' 'ct'; 'vCho' 'vBu'};
choices={'cF_Rej_vGamble' [1 1];'cF_NonRej_vGamble'  [1 2];'ct_Rej_vGamble'  [2 1];'ct_NonRej_vGamble'  [2 2]}; condnames={'cF' 'ct'; 'Rej' 'NonRej'};
% choices={'cF_Rej_vBestUnchosen' [1 1];'cF_NonRej_vBestUnchosen'  [1 2];'ct_Rej_vBestUnchosen'  [2 1];'ct_NonRej_vBestUnchosen'  [2 2]}; condnames={'cF' 'ct'; 'Rej' 'NonRej'};

% choices={'cF_vBestUnchosen_pos' [1 1];'cF_vBestUnchosen_neg'  [1 2];  'ct_vBestUnchosen_pos' [2 1];'ct_vBestUnchosen_neg'  [2 2]};   condnames={'cF' 'ct'; 'PosvBu' 'NegvBu'};
