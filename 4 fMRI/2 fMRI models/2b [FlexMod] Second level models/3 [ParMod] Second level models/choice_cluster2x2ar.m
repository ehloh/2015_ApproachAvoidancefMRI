...
% Assign Choices (Accept/Reject only)
choices={'out_cF_Accept' [1 1];'out_cF_Reject'  [1 2];'out_ct_NoBomb'  [2 1];'out_ct_Bomb'  [2 2]};
...
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [ -1 -1 1 1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'Acc-Rej'; % Compare Reject & Explore
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [1 -1 1 -1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'Reject-Accept';
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [-1 1 -1 1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'cF_Acc-Rej'; % Comparing cells (Ex vs VEx)
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [1 -1 0 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'cF_Rej-Acc'; 
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [-1 1 0 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'ct_Acc-Rej'; 
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [0 0 1 -1 ];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'ct_Rej-Acc'; 
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [0 0 -1 1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'Acc_cF-ct';  % Comparing cells (Task)
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [1 0 -1 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'Acc_ct-cF';  
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [-1 0 1 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'Rej_cF-ct';
