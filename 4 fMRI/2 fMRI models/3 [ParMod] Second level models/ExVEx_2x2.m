function [ matlabbatch contrastfiles] = ExVEx_2x2(log,where,  subjectlist, firstlevelmodel, secondlevelmodel, RLvariables,choices)
% [ matlabbatch contrastfiles] = ExVEx_2x2(log,where,  subjectlist, firstlevelmodel, secondlevelmodel, RLvariables,choices)
...
% Identify target contrasts: Explore & Conflict
Instruc={ 'cF_Explore' [] [1 1];
               'cF_VExplore' [] [1 2];
               'ct_Explore' [] [2 1];
               'ct_VExplore' [] [2 2];};
for i=1:size(Instruc,1)
    Instruc{i,2}=contrasts{find(strcmp(Instruc{i}, contrasts(:,1))),2};
end
...
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(2).name = 'ExVEx';
...
contrastfiles=cell(size(Instruc,1),1);
for i=1:size(Instruc,1)
    % Assign level
    matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(i).levels = Instruc{i,3};
    
    % Assign contrast files
    contrastfiles{i}=cell(length(subjectlist),1);
    for s=1:length(subjectlist)
        contrastfiles{i}{s}=[where.data_brain filesep subjectlist{s} filesep '2 First level' filesep firstlevelmodel ' Contrasted' filesep Instruc{i,2} ',1'];
    end
...
for s=1:length(subjectlist)
   ...
   matlabbatch{1}.spm.stats.factorial_design.cov(s).c = repmat(sub,[1 size(Instruc,1)])';
...
%% Run model + Add sensible contrasts

% (1) Execute (Specify only)
...
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [ -1 -1 1 1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'Ex-VEx'; % Compare Ex-Vex
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [1 -1 1 -1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'VEx-Ex';
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [-1 1 -1 1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'cF_Ex-VEx'; % Comparing cells (Ex vs VEx)
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [1 -1 0 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'cF_VEx-Ex'; 
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [-1 1 0 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'ct_Ex-VEx'; 
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [0 0 1 -1 ];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'ct_VEx-Ex'; 
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [0 0 -1 1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'Ex_cF-ct';  % Comparing cells (Task)
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [1 0 -1 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'Ex_ct-cF';  
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [-1 0 1 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'VEx_cF-ct';
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [0 1 0 -1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  'VEx_ct-cF';  
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [0 -1 0 1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
