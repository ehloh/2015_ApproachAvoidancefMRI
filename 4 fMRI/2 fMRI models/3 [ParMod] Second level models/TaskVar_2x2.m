...
choices={'cF_Reject' [1 1];'cF_Explore'  [1 2];'ct_Bomb'  [2 1];'ct_Explore'  [2 2]};  condnames={'cF' 'ct'; 'Rej' 'Expl'};
% choices={'cF_vChosen' [1 1];'cF_vBestUnchosen'  [1 2];'ct_vChosen'  [2 1];'ct_vBestUnchosen'  [2 2]};
% choices={'cF_Rej_vGamble' [1 1];'cF_NonRej_vGamble'  [1 2];'ct_Rej_vGamble'  [2 1];'cF_NonRej_vGamble'  [2 2]}; condnames={'cF' 'ct'; 'Rej' 'NonRej'};
% choices={'cF_Rej_vGamble' [1 1];'cF_NonRej_vGamble'  [1 2];'ct_Rej_vGamble'  [2 1];'cF_NonRej_vGamble'  [2 2]}; condnames={'cF' 'ct'; 'Rej' 'NonRej'};
% choices={'cF_Rej_vMargCho' [1 1]; 'cF_NonRej_vMargCho' [1 2]; 'ct_Rej_vMargCho' [2 1]; 'ct_NonRej_vMargCho' [2 2]}; condnames={'cF' 'ct'; 'Rej' 'NonRej'};
% choices={'cF_vBest' [1 1]; 'cF_vWorst' [1 2]; 'ct_vBest' [2 1]; 'ct_vWorst' [2 2]}; condnames={'cF' 'ct'; 'vBest' 'vWorst'};
% choices={'cF_ExploredBombxEntropy' [1 1]; 'cF_ExploredNobombxEntropy' [1 2]; 'ct_ExploredBombxEntropy' [2 1]; 'ct_ExploredNobombxEntropy' [2 2]}; condnames={'cF' 'ct'; 'Bomb' 'NoBomb'};



disp('Ingoing contrasts:'), disp(choices),  disp('Condition short names:'), disp(condnames),  input('Continue?');
...
% Sensible contrasts
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{1,1} '-' condnames{1,2}]; % Compare tasks
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [1 1 -1 -1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{1,2} '-' condnames{1,1}];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [ -1 -1 1 1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{2,1} '-' condnames{2,2}]; % 
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [1 -1 1 -1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{2,2} '-' condnames{2,1}]; 
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [-1 1 -1 1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{1,1} '_' condnames{2,1} '-' condnames{2,2}]; % 
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [1 -1 0 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{1,1} '_' condnames{2,2} '-' condnames{2,1}]; 
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [-1 1 0 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{1,2} '_' condnames{2,1} '-' condnames{2,2}];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [0 0 1 -1 ];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{1,2} '_' condnames{2,2} '-' condnames{2,1}]; 
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [0 0 -1 1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{2,1} '_' condnames{1,1} '-' condnames{1,2}]; % Comparing cells (Task)
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [1 0 -1 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{2,1} '_' condnames{1,2} '-' condnames{1,1}];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [-1 0 1 0];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{2,2} '_' condnames{1,1} '-' condnames{1,2}];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [0 1 0 -1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
matlabbatch{1}.spm.stats.con.consess{c}.tcon.name =  [condnames{2,2} '_' condnames{1,2} '-' condnames{1,1}];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.convec = [0 -1 0 1];
matlabbatch{1}.spm.stats.con.consess{c}.tcon.sessrep = 'none'; c=c+1;
