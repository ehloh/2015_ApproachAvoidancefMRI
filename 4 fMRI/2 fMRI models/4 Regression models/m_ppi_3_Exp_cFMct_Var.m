function [ matlabbatch] = m_ppi_3_Exp_cFMct_Var(log,where,behvar)
% [ matlabbatch] = m_ppi_3_Exp_cFMct_Var(log,where,behvar)
...
if strcmp(log.ppimodel(length(log.ppimodel)-8:end), 'Exp_cF-ct')==0
