...
THIS SCRIPT: doing PPI!! implement F in the base folder, and it will have to be ants transformed and integrated with the other contrasts (and the SPM.mat file in _Basic) in the original folder, and then transferred over to whichever AntsType folders there are
